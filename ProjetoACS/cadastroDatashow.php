...
<html lang="pt-br">
    ...
    <title>Cadastro do Datashow</title>
    ...
    <main>
        ...
        <!--LISTAGEM PESQUISA-->
				...
				<!-- ____________________________________reserva____________________________________________________________________________ -->
        <section class="container-grid cadastroFormulario">
        <form action="../reservadatashow.php" method="post" id="termoDeLocacaoDeProjetores">
        <div id="#" class="#">
