...
<html lang="pt-br">
    ...
    <title>Cadastro do Equipamento de video</title>
    ...
    <main>
        ...
        <?php
            if (isset($_POST['pesquisar'])) {
                ...
                include '../pesquisa_equipaudio.php';
            }else{
        ?>
        ...
        <section class="container-grid cadastroFormulario">
        <form action="../reserva_equipaudio.php" method="post" id="termoDeLocacaoDeProjetores">
        <div id="#" class="#">
            ...
            <input id="ramalDataShow" type="text" placeholder="amplificador, caixa de som e aparelho de DVD" class="campo" name=recurso>
