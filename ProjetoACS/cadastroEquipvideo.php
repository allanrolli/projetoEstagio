    ...
    <main>
        ...
        <?php
            if (isset($_POST['pesquisar'])) {
                ...
                include '../pesquisa_equipvideo.php';
            }else{
        ?>
        ...
        <section class="container-grid cadastroFormulario">
        <form action="../reserva_equipvideo.php" method="post" id="termoDeLocacaoDeProjetores">
        <div id="#" class="#">
            ...
            <input id="ramalDataShow" type="text" placeholder="televisão, câmera fotográfica e filmadora" class="campo" name=recurso>
        </div>
